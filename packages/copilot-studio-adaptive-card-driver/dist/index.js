...
__export(src_exports, {
  AdaptiveCardDriver: () => AdaptiveCardDriver_default
});
module.exports = __toCommonJS(src_exports);

// src/private/AdaptiveCardDriver.tsx
var import_css2 = require("@emotion/css");
var import_botframework_webchat = require("botframework-webchat");
var import_botframework_webchat_api = require("botframework-webchat-api");
var import_react = __toESM(require("react"));

// src/private/AdaptiveCardDriver.className.ts
var import_css = require("@emotion/css");
var className = (0, import_css.css)({
  "&.copilot-studio__adaptive-card-driver.copilot-studio__adaptive-card-driver--customized": {
    ...
    "& .ac-actionSet": { flexDirection: "column !important" },
...
var AdaptiveCardDriver_className_default = className;

// src/private/AdaptiveCardsHostConfig.ts
var AdaptiveCards = __toESM(require("adaptivecards"));
var AdaptiveCardsHostConfig_default = {
...
// src/private/buildChatCard.ts
function buildChatCard(activity) {
  return {
    type: "AdaptiveCard",
...
// src/private/AdaptiveCardDriver.tsx
var { AdaptiveCardContent, Composer } = import_botframework_webchat.Components;
var { useActivities } = import_botframework_webchat_api.hooks;
var _ = () => {
  const [activities] = useActivities();
  const firstBotMessageActivity = (0, import_react.useMemo)(
    () => activities.findLast(
      (activity) => activity.from.role === "bot" && activity.type === "message"
    ),
    [activities]
  );
  const card = (0, import_react.useMemo)(() => {
    const card2 = firstBotMessageActivity?.attachments?.find(
      ({ contentType }) => contentType === "application/vnd.microsoft.card.adaptive"
    );
    return card2 ? card2.content : firstBotMessageActivity && buildChatCard(firstBotMessageActivity);
  }, [firstBotMessageActivity]);
  return card && /* @__PURE__ */ import_react.default.createElement(AdaptiveCardContent, { content: card });
};
var AdaptiveCardDriver_default = (0, import_react.memo)(function CardDriver({ directLine, store }) {
  const props = {
    adaptiveCardsHostConfig: AdaptiveCardsHostConfig_default,
    directLine,
    store
  };
  return /* @__PURE__ */ import_react.default.createElement(
    "div",
    {
      className: (0, import_css2.cx)(
        "copilot-studio__adaptive-card-driver copilot-studio__adaptive-card-driver--customized",
        AdaptiveCardDriver_className_default
      )
    },
    /* @__PURE__ */ import_react.default.createElement(Composer, { ...props }, /* @__PURE__ */ import_react.default.createElement(_, null))
  );
});
