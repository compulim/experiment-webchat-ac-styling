...
// src/private/AdaptiveCardDriver.tsx
var { AdaptiveCardContent, Composer } = Components;
var { useActivities } = hooks;
var _ = () => {
  const [activities] = useActivities();
  const firstBotMessageActivity = useMemo(
    () => activities.findLast(
  ...
  return card && /* @__PURE__ */ React.createElement(AdaptiveCardContent, { content: card });
};
var AdaptiveCardDriver_default = memo(function CardDriver({ directLine, store }) {
  const props = {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Composer, { ...props }, /* @__PURE__ */ React.createElement(_, null))
  );
});
export {
  AdaptiveCardDriver_default as AdaptiveCardDriver
};
